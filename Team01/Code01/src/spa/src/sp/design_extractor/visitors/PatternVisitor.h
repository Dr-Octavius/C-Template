#ifndef SPA_PATTERNVISITOR_H
#define SPA_PATTERNVISITOR_H
...
class PatternVisitor : public RelationshipVisitor {
private:
    std::map<std::pair<std::string, EntityType>, std::shared_ptr<AssignNode>> assignPatternData;
    std::map<std::pair<std::string, EntityType>, std::unordered_set<std::pair<std::string, EntityType>, PairHash>> ifPatternData;
    std::map<std::pair<std::string, EntityType>, std::unordered_set<std::pair<std::string, EntityType>, PairHash>> whilePatternData;
...
public:
    ...
    const std::map<std::pair<std::string, EntityType>, std::shared_ptr<AssignNode>>& getAssignPatternData() const;
    const std::map<std::pair<std::string, EntityType>, std::unordered_set<std::pair<std::string, EntityType>, PairHash>>& getIfPatternData() const;
    const std::map<std::pair<std::string, EntityType>, std::unordered_set<std::pair<std::string, EntityType>, PairHash>>& getWhilePatternData() const;

    void setStmtNumberMap(const std::map<std::string, EntityType>& map);
};

#endif //SPA_PATTERNVISITOR_H
