#ifndef SPA_MODIFIESVISITOR_H
#define SPA_MODIFIESVISITOR_H
...
class ModifiesVisitor : public RelationshipVisitor {
public:
    std::map<std::pair<std::string, EntityType>, std::unordered_set<std::pair<std::string, EntityType>, PairHash>> modifies;
